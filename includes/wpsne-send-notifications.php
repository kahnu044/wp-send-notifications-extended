                ...
                <div id="dashboard_quick_press" class="postbox ">
                    ...
                    <div class="inside">
                        <form name="post" action="" method="post" id="admin-send-notifications">
                            ...
                            <div>
                                <label for="wpsne-app-id"><b><?php _e('Sent To', 'wp-send-notifications-extended'); ?> : </b>
                            ...
                            <div>
                                <label for="wpsne-app-id" class="form-label"><b><?php _e('Add Button Link ', 'wp-send-notifications-extended'); ?>: </b>
